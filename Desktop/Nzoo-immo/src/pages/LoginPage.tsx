                ...
                {activeTab === 'login' && (
                  <form className="space-y-6" onSubmit={handleSubmit}>
                    ...
                    >
                      {isLoading ? (
                        <>
                          <div className="animate-spin -ml-1 mr-3 h-6 w-6 border-2 border-nzoo-white border-t-transparent rounded-full"></div>
                          {t.login.loading}
                        </>
                      ) : (
                        <>
                ...
                {activeTab === 'register' && (
                  <div className="space-y-6">
                    <div className="bg-gradient-to-r from-primary-600/20 to-primary-700/20 rounded-2xl p-8 border border-primary-400/30 text-center">
                      ...
                      <h3 className="text-2xl font-bold text-nzoo-white mb-2 font-montserrat">Fonctionnalité à venir</h3>
                      <p className="text-primary-100 text-lg">
