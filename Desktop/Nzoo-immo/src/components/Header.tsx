...
import { Globe, User, LogOut, LogIn, UserPlus, Menu, X, Settings } from 'lucide-react';
          ...
          <div className="flex items-center justify-between h-20">
            ...
            <div className="flex items-center space-x-3">
              ...
              {isAuthenticated ? (
                ...
                // Options de connexion/création de compte sur la page d'accueil, login et signup
                <div className="flex items-center space-x-3">
                  <Link
                    to="/login"
