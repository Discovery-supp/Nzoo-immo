  ...
  if (loading) {
    return (
      <div className="flex justify-center items-center h-64">
        <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-nzoo-dark"></div>
      </div>
    );
  }
    ...
    <div className="space-y-8">
      ...
      <div className="flex justify-center">
        <div className="flex space-x-2 bg-white rounded-lg shadow-sm border p-1">
          ...
          <button
            onClick={() => setSelectedType('salle-reunion')}
            className={`px-4 py-2 rounded-md text-sm font-medium transition-colors ${
              selectedType === 'salle-reunion'
                ? 'bg-nzoo-dark text-white'
                : 'text-gray-600 hover:text-gray-900'
            }`}
          >
              ...
              <div className="p-6">
                ...
                <div className="space-y-2 mb-4">
                  <div className="flex items-center text-sm text-gray-500">
                    ...
                    <span>Jusqu'à {space.nombre_occupants} personnes</span>
                  </div>
                  <div className="flex items-center text-sm text-gray-500">
