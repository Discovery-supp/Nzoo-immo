 ...
 */
export function getResendApiKey(providedApiKey) {
 ...
 */
export function getResendApiKeyOrNull(providedApiKey) {
    // Priority order: 1) Environment variable, 2) Command line parameter
 ...
 */
export function getResendApiKeyDocsUrl() {
    return RESEND_API_KEY_DOCS_URL;
}
//# sourceMappingURL=resend-api.js.map