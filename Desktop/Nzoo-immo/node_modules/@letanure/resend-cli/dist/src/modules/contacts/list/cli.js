...
async function handleListCommand(options, command) {
    try {
        ...
        const listData = validateOptions(allOptions, ListContactsOptionsSchema, outputFormat, fields, command);
...
export function registerListContactsCommand(contactCommand) {
