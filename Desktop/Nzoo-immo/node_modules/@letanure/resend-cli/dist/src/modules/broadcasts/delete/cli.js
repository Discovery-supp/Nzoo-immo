...
async function handleDeleteCommand(options, command) {
    ...
    try {
        ...
        const validatedData = validateOptions(allOptions, deleteBroadcastSchema, outputFormat, fields, command);
        ...
        displayResults({
            ...
            operation: {
                ...
                error: {
                    ...
                    message: 'There was an error deleting the broadcast. Please check that the broadcast exists and is in draft status.',
                },
                dryRun: {
