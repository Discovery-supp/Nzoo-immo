...
async function handleSendCommand(options, command) {
    ...
    try {
        ...
        const validatedData = validateOptions(allOptions, sendBroadcastSchema, outputFormat, fields, command);
...
// Add CLI options
registerFieldOptions(broadcastSendCommand, fields);
const sendExamples = [
...
configureCustomHelp(broadcastSendCommand, fields, sendExamples);
