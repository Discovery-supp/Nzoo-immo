...
async function handleUpdateCommand(options, command) {
    ...
    try {
        ...
        const contactData = validateOptions(processedOptions, updateContactSchema, outputFormat, fields, command);
...
export function registerUpdateContactCommand(contactsCommand) {
