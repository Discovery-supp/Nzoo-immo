...
import { DeleteAudienceOptionsSchema } from './schema.js';
export const Form = ({ onExit }) => {
    ...
    if (isSubmitting) {
        return (_jsx(Layout, { headerText: `${config.baseTitle} - Audiences - Delete`, showNavigationInstructions: false, navigationContext: "none", children: _jsx(Spinner, { label: "Deleting audience..." }) }));
    }
    if (successData) {
        return (_jsx(SuccessScreen, { data: successData, successMessage: "Audience Deleted Successfully", headerText: `${config.baseTitle} - Audiences - Delete`, isDryRun: isDryRunSuccess, onExit: () => {
                setSuccessData(null);
                setIsDryRunSuccess(false);
                onExit();
            } }));
    ...
    if (error) {
        return (_jsx(ErrorScreen, { title: error.title, message: error.message, suggestion: error.suggestion, headerText: `${config.baseTitle} - Audiences - Delete`, onExit: () => {
                setError(null);
                onExit();
    ...
    return (_jsx(Layout, { headerText: `${config.baseTitle} - Audiences - Delete`, showNavigationInstructions: true, navigationContext: "form-single", children: _jsx(SimpleForm, { fields: formFields, onSubmit: handleSubmit, onCancel: onExit, validateWith: DeleteAudienceOptionsSchema, initialData: initialFormData }) }));
};
