...
async function handleCreateCommand(options, command) {
    ...
    try {
        ...
        const contactData = validateOptions(processedOptions, CreateContactOptionsSchema, outputFormat, fields, command);
        ...
        displayResults({
            ...
            operation: {
                success: {
                    ...
                    message: (data) => `Contact ID: ${data?.id || 'Unknown'}`,
                },
                error: {
...
export function registerCreateContactCommand(contactsCommand) {
