...
async function handleCreateAudienceCommand(options, command) {
    try {
        ...
        const audienceData = validateOptions(allOptions, CreateAudienceOptionsSchema, outputFormat, fields, command);
...
export function registerCreateAudienceCommand(audienceCommand) {
