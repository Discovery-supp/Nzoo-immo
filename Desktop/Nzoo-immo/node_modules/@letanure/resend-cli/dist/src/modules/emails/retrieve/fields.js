...
export const fields = filterFieldsForCli(inputFieldNames, commonEmailFields);
// Export display fields for result formatting (using shared constant)
export const displayFields = filterFieldsForDisplay(EMAIL_DETAIL_FIELDS, commonEmailFields);
