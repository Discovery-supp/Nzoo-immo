...
async function handleRetrieveCommand(options, command) {
    try {
        ...
        const retrieveData = validateOptions(allOptions, RetrieveContactOptionsSchema, outputFormat, fields, command);
...
export function registerRetrieveContactCommand(contactCommand) {
