...
vi.mock('./modules/emails/cancel/action.js', () => ({
    cancelEmail: vi.fn(() => Promise.resolve({
        success: true,
        data: { id: 'test-email-id', object: 'email' },
    })),
}));
vi.mock('./modules/audiences/create/action.js', () => ({
    createAudience: vi.fn(() => Promise.resolve({
        success: true,
        data: {
            id: 'test-audience-id',
            object: 'audience',
...
vi.mock('./modules/audiences/retrieve/action.js', () => ({
    retrieveAudience: vi.fn(() => Promise.resolve({
        success: true,
        data: {
            id: 'test-audience-id',
            object: 'audience',
...
vi.mock('./modules/audiences/delete/action.js', () => ({
    deleteAudience: vi.fn(() => Promise.resolve({
        success: true,
        data: {
            id: 'test-audience-id',
            object: 'audience',
...
vi.mock('./modules/audiences/list/action.js', () => ({
    listAudiences: vi.fn(() => Promise.resolve({
        success: true,
        data: {
            object: 'list',
            data: [
