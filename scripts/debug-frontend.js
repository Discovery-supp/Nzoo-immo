...
/**
 * Script de diagnostic frontend en temps réel
 * Usage: node scripts/debug-frontend.js
 */

console.log('🔍 Diagnostic Frontend - Nzoo Immo\n');

console.log('📋 Instructions pour diagnostiquer le frontend :');
console.log('');
...
console.log('Effectuez une réservation et surveillez les logs ci-dessus.');
